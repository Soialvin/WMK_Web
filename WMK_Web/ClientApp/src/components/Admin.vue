              ...
              >
                <div class="d-grid gap col-md-4 col-lg-4 gap-3">
                  <div class="d-flex align-items-start">
                    <i
                      class="ph-fill ph-circle font-size-10 text-primary mt-1"
                    ></i>
                  ...
                  <div class="d-flex align-items-start">
                    <i
                      class="ph-fill ph-circle font-size-10 text-info mt-1"
                    ></i>
                    <div class="ms-2" style="line-height: 1.5">
                ...
                <!-- <apexchart height="200" type="radialBar" class="col-md-8 col-lg-8 admin-chart-03"
                                           :options="adminChart.options" :series="adminChart.series" /> -->
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card">
            ...
            <div class="card-body text-center pt-0 p-2">
              <!-- <flat-picker v-model="inlineDate" class="d-none" :config="inlineDatepicker"
        ...
        <div class="col-lg-4">
          <div class="card">
            ...
            <div class="card-body text-center pt-0">
              <!-- <apexchart class="d-flex justify-content-center" width="350" style="min-height: 259.367px" type="pie"
                                       :options="adminChart1.options" :series="adminChart1.series" /> -->
